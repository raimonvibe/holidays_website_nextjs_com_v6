...
function createSnowflake(button: HTMLElement) {
    ...
    snowflake.style.top = `${-20}px`;  // Start above the button
    snowflake.style.fontSize = `${Math.random() * 10 + 10}px`;  // Variable size
    snowflake.style.opacity = `${Math.random() * 0.5 + 0.5}`;  // Variable opacity
    snowflake.style.transition = 'top 2s ease-in, left 2s ease-in-out';
    button.appendChild(snowflake);

    // Animation
    setTimeout(() => {
        snowflake.style.top = `${button.offsetHeight + 20}px`;  // Move past the bottom of the button
        snowflake.style.left = `${Math.random() * button.offsetWidth}px`;  // Horizontal movement
    }, 50);
...
function createMultipleSnowflakes(button: HTMLElement) {
    for (let i = 0; i < 5; i++) {
...
export default function RootLayout({
  ...
  useEffect(() => {
    const socialButtons = document.querySelectorAll('.Social:not(.footer-social)');
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Discover custom digital artworks with Raimon, your freelance web designer and developer from West Friesland. Specialist in responsive design and expert in HTML, CSS, and JavaScript. Experience a seamless digital experience, optimized for every screen - from the palm of your hand to the wide screen of your desktop."
        />
        <meta
          name="keywords"
          content="freelance web designer, web developer, responsive web design, HTML, CSS, JavaScript, digital art, Raimon, custom-made websites, Netherlands, West Friesland"
        />
        ...
        <meta name="twitter:image" content="https://raimonvibe.nl/static/media/raimon100.37739e52106e6e1f1b12.webp" />
