...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy and data processing information for Raimonvibe website.',
};
...
<div>
  <main>
    <div style={{ marginLeft: '10px' }}>
      ...
      <p>
        <span>info@raimonvibe.com</span>
      </p>
      <p>
        <span></span>
      </p>
      <p>
        <span>Personal data that we process</span>
      </p>
      <p>
        <span>
      ...
      <p>
        <span>Security and retention of personal data</span>
      </p>
      <p>
        <span>
      ...
      <p>
        <span>
          <a href="https://cookie-script.com/">
      ...
      <p>
        <span>Cookie: Heap Analytics.</span>
      </p>
      <p>
        <span>Name: Heap Analytics.</span>
      </p>
      <p>
        <span>
      ...
      <p>
        <span>Cookie: CookieScript.</span>
      </p>
      <p>
        <span>Name: CookieScript.</span>
      </p>
      <p>
        <span>
      ...
      <p>
        <span>View, adjust, or delete data</span>
      </p>
      <p>
        <span>
      ...
      <p>How we protect personal data</p>
      <p>
        <span>
